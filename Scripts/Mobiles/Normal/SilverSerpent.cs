...
namespace Server.Mobiles
{
    ...
    public class SilverSerpent : BaseCreature
    {
        ...
        public override void OnDeath(Container c)
        {
			...
			/* Editededited by Phoo 12/26/2017
			   This edit is a work around so that Silver Serpents drop the Snake Skins for imbueing skill
			   Original Code:
			...
			*/
            ...
            if (Utility.RandomDouble() < 0.1){
                switch( Utility.Random( 2 )) {
                    case 0: c.DropItem(new SilverSerpentVenom()); break;
                    case 1: c.DropItem(new SilverSnakeSkin()); break;
                }
			}
		}
