...
{
    [CorpseName("a angelic horse corpse")]
    public class Angelicmare : BaseMount
    {
        ...
        [Constructable]
        public Angelicmare(string name)
            : base(name, 0x74, 0x3EA7, AIType.AI_Healer, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            ...
            this.SetHits(22298, 43315);

            this.SetDamage(60, 100);

            this.SetDamageType(ResistanceType.Physical, 140);
            this.SetDamageType(ResistanceType.Fire, 140);
            this.SetDamageType(ResistanceType.Cold, 140);
            this.SetDamageType(ResistanceType.Poison, 140);
            this.SetDamageType(ResistanceType.Energy, 140);			
		...
		public Angelicmare(Serial serial)
            : base(serial)
        {
        }
