...
namespace daat99
{
	...
	public class OWLTRbodGump : Gump
	{
		...
		//	AddBackground(0, 0, 390, 125, 3600);
            ...
            string s_CP = String.Format("{0}:{1}:{2}", from.NextCarpentryBulkOrder.Hours, from.NextCarpentryBulkOrder.Minutes, from.NextCarpentryBulkOrder.Seconds);
            if (from.NextCarpentryBulkOrder == TimeSpan.Zero)
            {
            ...
            string s_BF = String.Format("{0}:{1}:{2}", from.NextFletchingBulkOrder.Hours, from.NextFletchingBulkOrder.Minutes, from.NextFletchingBulkOrder.Seconds);
            if (from.NextFletchingBulkOrder == TimeSpan.Zero)
            {
