	...
	public class WorldOmniporter : Item
	{
		...
		public static void Initialize()
		{
			...
			GlobalEntries.Add("Custom", new OmniEntry[] //add locations to the custom map here
			{
				...
				//new OmniEntry("Auction/Meeting House", new Point3D(1045, 570, -90), Map.Malas ),
				new OmniEntry("The Arena", new Point3D(877, 1858, 0), Map.Felucca ),
				new OmniEntry("Training Room", new Point3D(24, 1272, 0), Map.Malas ),
				...
				new OmniEntry("Deco Mall", new Point3D(6542, 2353, 0), Map.Trammel ),
				//new OmniEntry("Triple Champ Abyss", new Point3D(7051, 720, 32), Map.Felucca ),
