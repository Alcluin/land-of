    ...
    public class DefBowFletching : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
           ...
           // this.AddSubRes(typeof(Board), 1072643, 00.0, 1044041, 1072652);
			...
			this.AddSubRes(typeof(OakLog), 1072644, 20.0, 1044041, 1072652);
            this.AddSubRes(typeof(AshLog), 1072645, 30.0, 1044041, 1072652);
            this.AddSubRes(typeof(YewLog), 1072646, 40.0, 1044041, 1072652);
            this.AddSubRes(typeof(HeartwoodLog), 1072647, 50.0, 1044041, 1072652);
            this.AddSubRes(typeof(BloodwoodLog), 1072648, 60.0, 1044041, 1072652);
            this.AddSubRes(typeof(FrostwoodLog), 1072649, 70.0, 1044041, 1072652);
			
			this.AddSubRes(typeof(EbonyLog), "Ebony", 80.0, 1072652);
			this.AddSubRes(typeof(BambooLog), "Bamboo", 90.0, 1072652);
			this.AddSubRes(typeof(PurpleHeartLog), "PurpleHeart", 100.0,  1072652);
			this.AddSubRes(typeof(RedwoodLog), "Redwood", 110.0, 1072652);
			this.AddSubRes(typeof(PetrifiedLog), "Petrified", 119.0, 1072652);
