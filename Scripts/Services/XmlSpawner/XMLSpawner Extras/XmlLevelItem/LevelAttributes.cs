...
namespace Server.Items
{
	...
	public class LevelAttributes
	{
		...
		public static WeaponAttributeInfo[] m_WeaponAttributes = new WeaponAttributeInfo[]
		{
			...
			new WeaponAttributeInfo( AosWeaponAttribute.HitLeechHits, "Hit Life Leech", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitLeechStam, "Hit Stamina Leech", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitLeechMana, "Hit Mana Leech", AttributeCategory.Hits, 3, 65 ),
			...
			new WeaponAttributeInfo( AosWeaponAttribute.HitMagicArrow, "Hit Magic Arrow", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitHarm, "Hit Harm", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitFireball, "Hit Fireball", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitLightning, "Hit Lightning", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitDispel, "Hit Dispel", AttributeCategory.Hits, 3, 50 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitColdArea, "Hit Cold Area", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitFireArea, "Hit Fire Area", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitPoisonArea, "Hit Poison Area", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitEnergyArea, "Hit Energy Area", AttributeCategory.Hits, 3, 65 ),
			new WeaponAttributeInfo( AosWeaponAttribute.HitPhysicalArea, "Hit Physical Area", AttributeCategory.Hits, 3, 65 ),
