...
namespace Server.Gumps
{
    ...
    public class NewPlayerVendorOwnerGump : Gump
    {
            ...
            : base(50, 200)
        {
			...
			this.AddHtml(40, 35, 260, 20, String.Format( "<basefont color=#FFFFFF>My charge per transaction is: {0}%<br><small>There is no per day charge.", m_Vendor.ChargePerTransaction * 100 ), false, false);
