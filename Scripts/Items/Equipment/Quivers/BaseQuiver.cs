...
namespace Server.Items
{
    ...
    public class BaseQuiver : Container, ICraftable, ISetItem, IVvVItem, IOwnerRestricted
    {
        ...
        private static readonly Type[] m_Ammo = new Type[]
        {
			...
			typeof(PoisonArrow), typeof(PoisonBolt),
			typeof(ExplosiveArrow), typeof(ExplosiveBolt),
			typeof(ArmorPiercingArrow), typeof(ArmorPiercingBolt),
			typeof(FreezeArrow), typeof(FreezeBolt),
			typeof(LightningArrowAmmo), typeof(LightningBolt)
        };
