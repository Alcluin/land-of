    ...
    public class InteriorDecorator : Item
    {
        ...
        private class InternalGump : Gump
        {
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                {
					case 1: command = DecorateCommand.Turn; 
							break;
					case 2: command = DecorateCommand.Up; 
							break;
					case 3: command = DecorateCommand.Down; 
							break;
					case 4: command = DecorateCommand.North; 
							break;
					case 5: command = DecorateCommand.East; 
							break;
					case 6: command = DecorateCommand.South; 
							break;
					case 7: command = DecorateCommand.West; 
							break;
                    // case 1:
